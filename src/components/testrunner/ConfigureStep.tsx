...
const TEST_TYPES: TestType[] = [
  { id: 'scope', name: 'Scope Test', icon: Target, description: 'Endpoint discovery', category: 'Functional', badge: 'PASS', badgeColor: 'bg-[#E8E5FF] text-[#574a7d]' },
  { id: 'vision', name: 'Vision/Goal', icon: Eye, description: 'Business goal validation', category: 'Functional', badge: 'PASS', badgeColor: 'bg-[#E8E5FF] text-[#574a7d]' },
  { id: 'feature', name: 'Feature Matrix', icon: Grid3X3, description: 'Feature coverage mapping', category: 'Functional', badge: 'PASS', badgeColor: 'bg-[#E8E5FF] text-[#574a7d]' },
  ...
  { id: 'e2e', name: 'E2E Test', icon: Route, description: 'Full user flow tests', category: 'Functional', badge: 'PASS', badgeColor: 'bg-[#E8E5FF] text-[#574a7d]' },
  ...
  { id: 'visual', name: 'Visual Regression', icon: Eye, description: 'UI snapshot comparison', category: 'Non-Functional', badge: 'PASS', badgeColor: 'bg-[#E8E5FF] text-[#574a7d]' },
  ...
  { id: 'chaos', name: 'Chaos Eng.', icon: CloudLightning, description: 'Fault injection recovery', category: 'Specialized', badge: 'PASS', badgeColor: 'bg-[#E8E5FF] text-[#574a7d]' },
  ...
  return (
    ...
    >
        ...
        <div className="flex-1 lg:flex-[3]">
          <div className="flex items-center justify-between mb-4">
            ...
            <div className="flex gap-3">
              <button onClick={selectAll} className="font-mono text-[12px] text-[#574a7d] font-medium hover:underline">
                Select All
              </button>
              <button onClick={deselectAll} className="font-mono text-[12px] text-[#574a7d] font-medium hover:underline">
                Deselect All
              </button>
            </div>
          </div>
                    ...
                    return (
                      <motion.button
                        ...
                        className={`
                          ...
                          ${isSelected
                            ? 'border-[#574a7d] bg-[rgba(90,143,94,0.04)] shadow-[0_0_0_3px_rgba(90,143,94,0.08)]'
                            : 'border-[#D9D9D3] bg-white hover:border-[#a39fd4] hover:bg-[#E8E5FF]'
                          }
                        `}
                      >
                        {/* Checkbox */}
                        <motion.div
                          ...
                          className={`
                            ...
                            ${isSelected ? 'bg-[#574a7d] border-[#574a7d]' : 'border-2 border-[#D9D9D3]'}
                          `}
                        >
                        ...
                        {/* Icon */}
                        <test.icon size={18} className="text-[#574a7d] flex-shrink-0" />
        ...
        <div className="lg:flex-[2] space-y-6">
            ...
            <div className="space-y-2">
              <button
                ...
                className={`w-full p-4 rounded-[10px] border-2 text-left transition-all duration-200 relative ${
                  testDepth === 'shallow'
                    ? 'border-[#574a7d] bg-[#F7F7FB]'
                    : 'border-[#D9D9D3] bg-[#F7F7FB] hover:border-[#a39fd4]'
                }`}
              >
                {testDepth === 'shallow' && (
                  <Check size={16} className="absolute top-3 right-3 text-[#574a7d]" />
                )}
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                className="w-full h-[6px] rounded-full appearance-none cursor-pointer accent-[#574a7d]"
                style={{
                  background: `linear-gradient(to right, #574a7d 0%, #574a7d ${(coverageTarget / 2) * 100}%, #ECEBF5 ${(coverageTarget / 2) * 100}%, #ECEBF5 100%)`
                }}
              />
              <div className="flex justify-between mt-2">
                <span className={`text-[12px] ${coverageTarget === 0 ? 'text-[#574a7d] font-medium' : 'text-[#9A9A9A]'}`}>Basic</span>
                <span className={`text-[12px] ${coverageTarget === 1 ? 'text-[#574a7d] font-medium' : 'text-[#9A9A9A]'}`}>Standard</span>
                <span className={`text-[12px] ${coverageTarget === 2 ? 'text-[#574a7d] font-medium' : 'text-[#9A9A9A]'}`}>Comprehensive</span>
              </div>
            </div>
          </div>
          ...
          <div>
            <button
              ...
              className="flex items-center gap-2 font-mono text-[12px] uppercase tracking-[0.08em] text-[#574a7d] font-medium hover:underline mb-3"
            >
              Advanced Options
            ...
            {showAdvanced && (
              <motion.div
                ...
                className="space-y-3 bg-[#F7F7FB] rounded-lg p-4"
              >
                <div>
          ...
          {/* Estimated Time */}
          <div className="bg-[#E8E5FF] rounded-xl p-5 text-center">
            <div className="font-mono text-[11px] uppercase tracking-[0.08em] text-[#6B6B6B] mb-1">
              Estimated Run Time
            </div>
            <div className="font-heading text-[32px] font-semibold text-[#574a7d]">
              ~{estimatedMinutes}
            </div>
      ...
      <div className="flex justify-between items-center mt-8 pt-6 border-t border-[#D9D9D3]">
        <button
          onClick={onBack}
          className="px-7 py-3.5 border border-[#D9D9D3] text-[#333333] rounded-lg font-body font-medium text-[15px] hover:bg-[#E8E5FF] hover:border-[#a39fd4] transition-all"
        >
          &larr; Back
        </button>
        <motion.button
          ...
          whileTap={{ scale: 0.98 }}
          className="px-8 py-3.5 bg-[#574a7d] text-white rounded-lg font-body font-medium text-[16px] flex items-center gap-2 hover:bg-[#4a3d6b] transition-colors"
        >
          <Zap size={16} />
          Run Tests &rarr;
        </motion.button>
