...
export default function IntegrationCTA() {
  return (
    <section className="relative bg-[#C1A3FF] py-24 lg:py-32 px-6 sm:px-12 lg:px-16 overflow-hidden">
      {/* Decorative pattern */}
      <div
      ...
      <div className="relative z-10 max-w-[800px] mx-auto text-center">
        ...
        >
          <button className="px-8 py-[14px] rounded-lg bg-white text-[#C1A3FF] font-body font-medium text-[16px] hover:bg-[#F5F5F0] hover:scale-[1.02] active:scale-[0.98] transition-all duration-200 flex items-center gap-2 group">
            Start Testing Free
